#include "meshElementQ4_AVX.h"

void meshElementQ4_AVX::calculateFormFunction(const Eigen::Vector3d& x, double lp, Eigen::VectorXd& v) {
...
void meshElementQ4_AVX::calculateDerivateFormFunction(const Eigen::Vector3d& x, double lp, Eigen::VectorXd& dv) {
...
void meshElementQ4_AVX::computeGlobalCoordinates(double ksi, double eta, double zeta, Eigen::Vector3d& global) {
